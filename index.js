...
class Grid extends react_1.default.PureComponent {
    ...
    render() {
        ...
        }, e("table", {}, e("tbody", null, ...rows)), e("div", {
            className: "scores",
        }, e("div", {}, `${this.state.scores[0]} - ${this.state.scores[1]}`)));
    }
...
react_dom_1.default.render(e(Grid, { nrows: 4, ncols: 4 }), document.getElementById("prophecies-grid-container"));
